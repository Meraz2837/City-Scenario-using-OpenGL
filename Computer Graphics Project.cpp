...
void display(void)
{
    ...
    */
    ...
    glBegin(GL_POLYGON);
    glVertex2d(100 + boatm, 75);
    glVertex2d(100 + boatm, 50);
    glVertex2d(50 + boatm, 100);
    glEnd();

    glColor3ub(100, 50, 32);
    glBegin(GL_POLYGON);
    glVertex2d(100 + boatm, 75);
    glVertex2d(250 + boatm, 75);
    glVertex2d(250 + boatm, 50);
    glVertex2d(100 + boatm, 50);
    glEnd();
    ...
    glBegin(GL_POLYGON);
    glVertex2d(100 + boatm, 75);
    glVertex2d(150 + boatm, 75);
    glVertex2d(125 + boatm, 110);
    glEnd();

    glColor3ub(52, 52, 52);
    glBegin(GL_POLYGON);
    glVertex2d(125 + boatm, 110);
    glVertex2d(225 + boatm, 110);
    glVertex2d(250 + boatm, 75);
    glVertex2d(150 + boatm, 75);
    glEnd();
    //Boat
...
int main(int argc, char** argv)
{
    ...
    glutCreateWindow("Meaningless Compiler 192-15-2837, 2865, 2895");
    init();
